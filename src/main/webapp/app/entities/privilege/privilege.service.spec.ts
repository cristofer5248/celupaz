...
describe('Service Tests', () => {
  describe('Privilege Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Privilege(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Privilege', async () => {
      ...
      it('should not update a Privilege', async () => {
      ...
      it('should partial update a Privilege', async () => {
        const patchObject = { ...new Privilege() };
      ...
      it('should not partial update a Privilege', async () => {
      ...
      it('should not return a list of Privilege', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Privilege', async () => {
