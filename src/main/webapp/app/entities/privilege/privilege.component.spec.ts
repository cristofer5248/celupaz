...
type PrivilegeComponentType = InstanceType<typeof Privilege>;
...
describe('Component Tests', () => {
  ...
  describe('Privilege Management Component', () => {
    ...
    let mountOptions: MountingOptions<PrivilegeComponentType>['global'];
    ...
    describe('Mount', () => {
      it('Should call load all on init', async () => {
        ...
        // WHEN
        const wrapper = shallowMount(Privilege, { global: mountOptions });
        const comp = wrapper.vm;
        await comp.$nextTick();

        // THEN
        expect(privilegeServiceStub.retrieve.calledOnce).toBeTruthy();
      ...
      it('should calculate the sort attribute for an id', async () => {
        ...
        // THEN
        expect(privilegeServiceStub.retrieve.lastCall.firstArg).toMatchObject({
          sort: ['id,asc'],
        });
      });
    });
    describe('Handles', () => {
      let comp: PrivilegeComponentType;
      ...
      beforeEach(async () => {
        ...
        privilegeServiceStub.retrieve.resolves({ headers: {}, data: [] });
      });
      ...
      it('should not load a page if the page is the same as the previous page', () => {
        ...
        // THEN
        expect(privilegeServiceStub.retrieve.called).toBeFalsy();
      });
      ...
      it('should re-initialize the page', async () => {
        ...
        expect(privilegeServiceStub.retrieve.callCount).toEqual(1);
        expect(comp.privileges[0]).toEqual(expect.objectContaining({ id: 123 }));
      });
