...
import com.chrisgeek.celupaz.service.PrivilegeService;
...
/**
 * REST controller for managing {@link com.chrisgeek.celupaz.domain.Privilege}.
 */
@RestController
...
public class PrivilegeResource {
    ...
    public ResponseEntity<Privilege> createPrivilege(@Valid @RequestBody Privilege privilege) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/privileges/" + privilege.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, privilege.getId().toString()))
            .body(privilege);
    }
    ...
    public ResponseEntity<Privilege> partialUpdatePrivilege(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Privilege privilege
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, privilege.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Privilege>> getAllPrivileges(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Privilege> getPrivilege(@PathVariable("id") Long id) {
